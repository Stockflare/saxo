module Saxo
  module Order
    class Place < Saxo::Base
      ...
      def call
        uri =  URI.join(Saxo.api_uri, 'v1/order/placeStockOrEtfOrder').to_s
        ...
        if result['status'] == 'SUCCESS'
          ...
          payload = {
            ...
            order_action: Saxo.place_order_actions.key(details['action']),
            quantity: details['quantity'].to_i,
            expiration: Saxo.order_expirations.key(details['universalOrderInfo']['expiration']),
